...
A Spring Boot-based Ecommerce Platform with authentication, product management, cart, orders, and payments. Built with Spring Boot, Spring Security (JWT), MySQL, and Lombok.
...
- Logs user registration and login attempts
